      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="w-screen h-screen origin-top bg-black text-white pt-4 pb-10 pl-6 pr-4 md:pr-16 flex flex-col items-end justify-start"
            style={{ 
              position: 'fixed', 
              top: 0, 
              left: 0, 
          ...
          >
            <button 
              className="p-4 sm:p-8 transition-colors duration-300 px-4 sm:px-8 md:px-16"
              onClick={() => setIsMenuOpen(!isMenuOpen)}
            >
              {isMenuOpen && (
